package org.openthos.taskmanager.prevent.ui.util;
...
public class PreventUtils {
    ...
    public static void updatePreventPkg(Context context, String[] packages, boolean add) {
        ...
        context.sendOrderedBroadcast(intent, PreventIntent.PERMISSION_SYSTEM,
                new PreventListReceiver(), null, 0, null, null);
    }
        ...
        private void handlePackages(Context context, String result) {
            try {
                ...
                if (prevents.size() == size) {
                    ...
                    UILog.e("updatePreventPkg prevents: " + prevents.size() + " != " + size);
                }
