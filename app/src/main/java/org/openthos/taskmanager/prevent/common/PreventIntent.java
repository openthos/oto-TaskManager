package org.openthos.taskmanager.prevent.common;

import android.net.Uri;

import org.openthos.taskmanager.Manifest;
...
public final class PreventIntent {
    ...
    public static final String NAMESPACE = "org.openthos.taskmanager.prevent.";
    ...
    public static final String KEY_PREVENT_LIST = "fragment_prevent";
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://org.openthos.taskmanager.prevent.provider");
