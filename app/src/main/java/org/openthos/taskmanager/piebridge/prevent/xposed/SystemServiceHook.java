...
import org.openthos.taskmanager.piebridge.prevent.framework.PreventLog;
import org.openthos.taskmanager.piebridge.prevent.framework.PreventRunning;
import org.openthos.taskmanager.piebridge.prevent.framework.util.ActivityRecordUtils;
import org.openthos.taskmanager.piebridge.prevent.framework.util.ProcessRecordUtils;
import org.openthos.taskmanager.piebridge.prevent.framework.util.ReflectUtils;
import org.openthos.taskmanager.piebridge.prevent.framework.util.TaskRecordUtils;

public class SystemServiceHook extends XC_MethodHook {//XC_MehodHook是xposed jar中的；
    ...
    protected void afterHookedMethod(MethodHookParam param) throws Throwable {
        ...
        try {
            Class.forName("org.openthos.taskmanager.piebridge.PreventRunning", false, classLoader);
    ...
    private void hookIntentResolver(ClassLoader classLoader) {
        XposedHelpers.findAndHookMethod("com.android.server.IntentResolver", classLoader, "sortResults",
    ...
    private void hookActivityManagerServiceHandleAppDiedLocked(Class<?> activityManagerService,
        ...
        try {
            ...
            Class<?> processRecord = Class.forName("com.android.server.am.ProcessRecord",
                    false, classLoader);
    ...
    private void hookActivityManagerServiceStartActivity(Class<?> activityManagerService,
                                                         ClassLoader classLoader) throws ClassNotFoundException {
    ...
    private void hookActivityManagerServiceCleanUpRemovedTaskLocked(Class<?> activityManagerService,
                                                                    ClassLoader classLoader) throws ClassNotFoundException {
        int sdk = Build.VERSION.SDK_INT;
    ...
    private void hookActivityManagerServiceBindService(Class<?> activityManagerService, ClassLoader classLoader)
    ...
    private void hookActivityManagerServiceBroadcastIntent(Class<?> activityManagerService, ClassLoader classLoader)
            throws ClassNotFoundException {
        int sdk = Build.VERSION.SDK_INT;
    ...
    public static class AppDiedHook extends XC_MethodHook {
        ...
        protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
            ...
            Log.i("AppDiedHook-->", "param :::" + param.args[0x1] + "0000" + param.args[0]);
    ...
    public static class ProcessHook extends XC_MethodHook {
        ...
        protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
            ...
            Log.i("ProcessHook::", "param-->" + param.args[0x1] + "---" + param.args[0x4]);
    ...
    public static class IntentExcludingStoppedHook extends XC_MethodHook {
        ...
        protected void afterHookedMethod(XC_MethodHook.MethodHookParam param) throws Throwable {
            ...
            if (result != null && result && !preventRunning.isExcludingStopped(action)) {
                Log.i("ExcludingStoppedHook", "action" + action);//安全action
    ...
    public static class IntentFilterMatchHook extends XC_MethodHook {
        ...
        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
            ...
            if (match != result) {
                Log.i("IntentFilterMatchHook:", "------> action::" + action);
