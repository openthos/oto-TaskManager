package org.openthos.taskmanager.piebridge.prevent.common;
...
public final class PreventIntent {
    ...
    public static final String NAMESPACE = "org.openthos.taskmanager. piebridge.prevent.";
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://org.openthos.taskmanager. piebridge.prevent.provider");
