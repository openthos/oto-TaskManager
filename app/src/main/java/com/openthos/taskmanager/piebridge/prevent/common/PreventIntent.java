package com.openthos.taskmanager.piebridge.prevent.common;

import android.net.Uri;

import com.openthos.taskmanager.Manifest;
...
public final class PreventIntent {
    ...
    public static final String NAMESPACE = "com.openthos.taskmanager. piebridge.prevent.";
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://com.openthos.taskmanager. piebridge.prevent.provider");
