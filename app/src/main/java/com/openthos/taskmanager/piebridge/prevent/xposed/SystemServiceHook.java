...
import com.openthos.taskmanager.piebridge.prevent.framework.PreventRunning;
import com.openthos.taskmanager.piebridge.prevent.framework.util.ActivityRecordUtils;
import com.openthos.taskmanager.piebridge.prevent.framework.util.ProcessRecordUtils;
import com.openthos.taskmanager.piebridge.prevent.framework.util.ReflectUtils;
import com.openthos.taskmanager.piebridge.prevent.framework.util.TaskRecordUtils;
...
public class SystemServiceHook extends XC_MethodHook {//XC_MehodHook是xposed jar中的；
    ...
    protected void afterHookedMethod(MethodHookParam param) throws Throwable {
        ...
        try {
            Class.forName("com.openthos.taskmanager.piebridge.PreventRunning", false, classLoader);
